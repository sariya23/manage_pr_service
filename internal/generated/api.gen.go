...
type ServerInterface interface {
	// Получить количество PRs у каждого юзера
	// (GET /analytics/usersPRs)
	GetAnalyticsUsersPRs(w http.ResponseWriter, r *http.Request)
	// Проверка доступности сервиса
	// (GET /debug/ping)
	GetDebugPing(w http.ResponseWriter, r *http.Request)
	...
	// Изменить статус активности пользователей в команде
...
// Получить количество PRs у каждого юзера
// (GET /analytics/usersPRs)
func (_ Unimplemented) GetAnalyticsUsersPRs(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Проверка доступности сервиса
// (GET /debug/ping)
func (_ Unimplemented) GetDebugPing(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetAnalyticsUsersPRs operation middleware
func (siw *ServerInterfaceWrapper) GetAnalyticsUsersPRs(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetAnalyticsUsersPRs(w, r)
	}))
...
// GetDebugPing operation middleware
func (siw *ServerInterfaceWrapper) GetDebugPing(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetDebugPing(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/analytics/usersPRs", wrapper.GetAnalyticsUsersPRs)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/debug/ping", wrapper.GetDebugPing)
	})
	r.Group(func(r chi.Router) {
...
type GetAnalyticsUsersPRsRequestObject struct {
}

type GetAnalyticsUsersPRsResponseObject interface {
	VisitGetAnalyticsUsersPRsResponse(w http.ResponseWriter) error
}

type GetAnalyticsUsersPRs200JSONResponse map[string]int

func (response GetAnalyticsUsersPRs200JSONResponse) VisitGetAnalyticsUsersPRsResponse(w http.ResponseWriter) error {
...
type GetDebugPingRequestObject struct {
}

type GetDebugPingResponseObject interface {
	VisitGetDebugPingResponse(w http.ResponseWriter) error
}

type GetDebugPing200JSONResponse struct {
	Msg *string `json:"msg,omitempty"`
}

func (response GetDebugPing200JSONResponse) VisitGetDebugPingResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type PostTeamDeactivate200Response struct {
}

func (response PostTeamDeactivate200Response) VisitPostTeamDeactivateResponse(w http.ResponseWriter) error {
	w.WriteHeader(200)
	return nil
}

type PostTeamDeactivate400Response struct {
}

func (response PostTeamDeactivate400Response) VisitPostTeamDeactivateResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}

type PostTeamDeactivate404Response struct {
}

func (response PostTeamDeactivate404Response) VisitPostTeamDeactivateResponse(w http.ResponseWriter) error {
	w.WriteHeader(404)
	return nil
}
...
type StrictServerInterface interface {
	// Получить количество PRs у каждого юзера
	// (GET /analytics/usersPRs)
	GetAnalyticsUsersPRs(ctx context.Context, request GetAnalyticsUsersPRsRequestObject) (GetAnalyticsUsersPRsResponseObject, error)
	// Проверка доступности сервиса
	// (GET /debug/ping)
	GetDebugPing(ctx context.Context, request GetDebugPingRequestObject) (GetDebugPingResponseObject, error)
	// Создать PR и автоматически назначить до 2 ревьюверов из команды автора
	// (POST /pullRequest/create)
...
// GetAnalyticsUsersPRs operation middleware
func (sh *strictHandler) GetAnalyticsUsersPRs(w http.ResponseWriter, r *http.Request) {
	var request GetAnalyticsUsersPRsRequestObject

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetAnalyticsUsersPRs(ctx, request.(GetAnalyticsUsersPRsRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetAnalyticsUsersPRs")
	}
	...
	} else if validResponse, ok := response.(GetAnalyticsUsersPRsResponseObject); ok {
		if err := validResponse.VisitGetAnalyticsUsersPRsResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
...
// GetDebugPing operation middleware
func (sh *strictHandler) GetDebugPing(w http.ResponseWriter, r *http.Request) {
	var request GetDebugPingRequestObject

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetDebugPing(ctx, request.(GetDebugPingRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetDebugPing")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(GetDebugPingResponseObject); ok {
		if err := validResponse.VisitGetDebugPingResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
